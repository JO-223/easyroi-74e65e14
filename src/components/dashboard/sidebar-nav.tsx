...
export function SidebarNav() {
  ...
  return <div className="flex flex-col h-full text-sidebar-foreground bg-easyroi-navy">
      ...
      <nav className="space-y-1 px-3 flex-1">
        ...
        return <Link key={item.href} to={item.href} className={cn("flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors", isActive ? "bg-sidebar-accent text-easyroi-gold" : "text-sidebar-foreground hover:text-easyroi-gold hover:bg-sidebar-accent/50")}>
      ...
      <div className="p-4 space-y-2">
        ...
        <Link to="/logout" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-white hover:text-easyroi-gold hover:bg-sidebar-accent/50 transition-colors w-full">
          <span>{t('logout')}</span>
        </Link>
      </div>
    </div>;
