const it = {
  ...
  termsIntroductionText: "Benvenuto nei Termini di Servizio di EasyROI. Ti invitiamo a leggere attentamente questi termini, che regolano l'accesso e l'utilizzo della piattaforma EasyROI e dei relativi servizi offerti.",
  termsUsage: "Utilizzo del Servizio",
  termsUsageText: "Utilizzando EasyROI, accetti di impiegare il servizio esclusivamente per scopi leciti, in conformità con le leggi vigenti e nel pieno rispetto di questi Termini.",
  termsAccount: "Responsabilità dell'Account",
  termsAccountText: "Sei personalmente responsabile della sicurezza del tuo account e della relativa password. EasyROI non potrà essere ritenuta responsabile per eventuali perdite o danni causati dalla tua mancata adozione di misure adeguate a garantire tale sicurezza.",
  termsIntellectualProperty: "Proprietà Intellettuale",
  termsIntellectualPropertyText: "Il servizio commerciale offerto tramite la piattaforma EasyROI e i relativi contenuti aziendali sono proprietà esclusiva di EasyROI. Il sito web, inclusi design originale, struttura, funzionalità tecniche, codice sorgente ed ogni elemento creativo, sono stati ideati e sviluppati integralmente da George Ionascu al di fuori dell'orario lavorativo e senza utilizzo di risorse aziendali. Pertanto, questi elementi rimangono di esclusiva proprietà intellettuale di George Ionascu. È vietata ogni forma di riproduzione, copia, modifica, distribuzione o sfruttamento senza autorizzazione scritta del proprietario.",
  termsLimitations: "Limitazioni di Responsabilità",
  termsLimitationsText: "EasyROI non sarà responsabile in alcun caso per danni di qualsiasi natura, inclusi, a titolo esemplificativo ma non esaustivo, danni diretti, indiretti, incidentali, speciali, punitivi o consequenziali derivanti o connessi all'uso del servizio.",
  termsTermination: "Cessazione e Sospensione",
  termsTerminationText: "EasyROI si riserva il diritto di sospendere o chiudere immediatamente il tuo account e l'accesso ai servizi, senza obbligo di preavviso o responsabilità, qualora vengano riscontrate violazioni di questi termini o per qualsiasi altra ragione ritenuta valida da EasyROI.",
  termsGoverning: "Legge Applicabile",
  termsGoverningText: "I presenti Termini saranno regolati e interpretati secondo le leggi italiane, senza riferimento a eventuali conflitti normativi o disposizioni internazionali.",
