...
const translations = {
  ...
  portalFees: "Commissioni portali",
  cleaningCosts: "Costi pulizia",
  touristTax: "Tassa turistica",
  grossTotal: "Totale lordo",
  utilityCosts: "Costi utenze",
  ...
  // Club Deal
  clubDeals: "Club Deal",
  exploreClubDealOpportunities: "Esplora opportunità di investimento condiviso",
  clubDealStatus_fundraising: "Raccolta fondi in corso",
  clubDealStatus_purchased: "Immobili acquistati",
  clubDealStatus_rented: "In affitto",
  clubDealStatus_readyForSale: "Pronto alla rivendita",
  clubDealDetails: "Dettagli Club Deal",
  totalPrice: "Prezzo totale",
  minInvestment: "Investimento minimo",
  expectedAnnualRoi: "ROI annuale atteso",
  expectedTotalRoi: "ROI totale atteso",
  currentValue: "Valore attuale",
  rentalPeriodYears: "Durata affitto (anni)",
  acquisitionDate: "Data di acquisto",
  fundraisingProgress: "Progresso raccolta fondi",
  investorsParticipating: "Investitori partecipanti",
  fundraisingDeadline: "Termine raccolta fondi",
  documents: "Documenti",
  businessPlans: "Business Plan",
  legalDocuments: "Documenti Legali",
  financialReports: "Report Finanziari",
  dealTimeline: "Cronologia Deal",
  ...
  noClubDealsFound: "Nessun Club Deal trovato",
  tryDifferentFilters: "Prova con filtri diversi",
  filterClubDeals: "Filtra Club Deals",
